...
namespace Itineris\WorldPay\Preflight;
...
use Itineris\WorldPay\AddOn;
use Itineris\WorldPay\Feed;

class ProductionMode extends AbstractChecker
{
    public const ID = 'gf-worldpay-production-mode';
    public const DESCRIPTION = 'Ensure all gf-worldpay feeds are in production mode.';
